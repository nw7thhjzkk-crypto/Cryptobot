...
def process_symbol(symbol, equity, open_positions, breaker_active, now_str):
    """Processes a single symbol, executing decision logic, risk management and order submission."""
    # Get price history
    ...
    watchlist_update = [symbol, regime, now_str]
...
def run_iteration(iteration):
    ...
    for symbol in WATCHLIST:
        update = process_symbol(symbol, equity, open_positions, breaker_active, now_str)
        if update:
            watchlist_updates.append(update)
